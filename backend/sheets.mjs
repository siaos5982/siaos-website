...
export const REPORTS={
  ...
  calendar:{table:'appointments',select:'id,user_id,service,related_service,consultation_mode,start_at,end_at,status,hold_expires_at,payment_reference,consultation_requests(id,details,status)',order:'start_at.asc,id.asc'},
  ...
  payments:{table:'payment_transactions',select:'id,user_id,gateway_order_id,gateway_payment_id,receipt,kind,item_slug,item_name,quantity,amount,currency,status,raw_status,method,paid_at,created_at',order:'created_at.asc,id.asc'},
