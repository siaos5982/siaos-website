(() => {
  ...
  function showPrompt() {
    ...
    const shell = document.createElement('div'); shell.className = 'account-prompt'; shell.innerHTML = `<div class="account-prompt-backdrop"></div><section class="account-prompt-card" role="dialog" aria-modal="true" aria-labelledby="accountPromptTitle"><img src="assets/siaos-official-logo.png" alt="Official SIAOS crest"><span class="kicker">Your SIAOS account</span><h2 id="accountPromptTitle">Keep your guidance<br><em>together.</em></h2><p>Create an account instantly with your email and mobile number. No OTP or password is required.</p><div class="account-prompt-actions"><a class="btn fill" href="login.html?mode=signup&next=${encodeURIComponent(next)}">Create Account</a><a class="btn" href="login.html?mode=signin&next=${encodeURIComponent(next)}">Sign In</a></div></section>`;
